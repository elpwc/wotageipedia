export default {
  ...
  demoTips: {
    start: {
      ...
      alert1: (
        <span>
          ここはヲタ芸ペディア(仮)の最終的なページの模様を部分的に示すための<b>DEMOページ</b>です。<b>あらゆる機能を含みません</b>
          <br />
          (当サイトの動画がすべて埋め込み機能でできているのです。著作権侵害になりません。)
          <br />
          <br /> <hr />
          <span style={{ backgroundColor: 'purple', padding: '5px', color: '#FFF', borderRadius: '5px' }}>紹介</span>
          <br />
          ヲタ芸ペディア（仮）はそれぞれ動画サイトで散らばっているヲタ芸動画にある技を系統的に登録・分類し、<span style={{ fontWeight: 'bold' }}>「技名・系・動作(?)・本家・...」</span>
          などいろんな情報で技を簡単に検索できるウェブサイトです。
          <br />
          <br />
    ...
    <hr />　//日本語アンケートはツイッターで
    */}
          <span style={{ backgroundColor: 'orange', padding: '5px', color: '#FFF', borderRadius: '5px' }}>開発協力</span>
          <br />
          <span>
            ヲタ芸ペディア（仮）はまだ開発が始まったばかりの非営利プロジェクトで、人手がめっちゃ足りていません、もし技術を持っていてヲタ芸の規範化に貢献したい方であれば、協力していただければ嬉しいです。
          </span>
          <br />
          連絡先：
          <br />
